...
func ParamHandler() {
	...
	common.Router.HandleFunc("/item/param/edit", updateCatController)
}

func updateCatController(w http.ResponseWriter, r *http.Request) {
	r.ParseForm()
	result := updateParamService(r.Form)
